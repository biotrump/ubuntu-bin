...
sudo aptitude install fonts-arphic-uming language-pack-gnome-zh-hans-base language-pack-zh-hans-base \
...
#nvidia openCL
# pyrit
sudo aptitude install nvidia-opencl-dev nvidia-cuda-doc
sudo aptitude install freeglut3-dev build-essential libx11-dev libxmu-dev \
...
#python3
sudo aptitude install python3 python3-all python3-numpy python3-scipy  python3-doc \
	python3-examples python3-sphinx python3-setuptools
#Pillow
sudo aptitude install libtiff4-dev libjpeg-dev libjpeg8-dev zlib1g-dev \
...
sudo aptitude install ssh smb-nat nbtscan libpam-winbind winbind
#android
sudo aptitude install git gnupg flex bison gperf build-essential \
...
#sudo apt-get update
sudo aptitude update
sudo aptitude install boot-repair
...
sudo aptitude update
sudo aptitude install texlive texlive-fonts-extras
...
sudo aptitude update
sudo aptitude install cmake cmake-gui

#chewing daily build ppa
sudo add-apt-repository ppa:chewing/chewing
sudo aptitude update
sudo aptitude install chewing-editor libchewing scim-chewing
...
sudo aptitude update
sudo aptitude install libeigen3-dev libeigen3-dev:i386 libeigen3-doc
